...
import ui.gui.dialogs.AddExpenseDialog;
import ui.gui.dialogs.AddRevenueDialog;
...
public class SimpleBudgeterUI implements Runnable {
    ...
    private EntryDisplay entryDisplay;
    ...
    public EntryDisplay getEntryDisplay() { return entryDisplay; }
    ...
    private void initializeSplitPane() {
        ...
        entryDisplay = new EntryDisplay(this);
...
//        entryScrollPane.setMinimumSize(new Dimension(WIDTH - (WIDTH / 5), HEIGHT)); // TODO: what min size do i want fo rirhgt side
        ...
        splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, monthScrollPane, entryDisplay);
    }
    ...
    private void initializeListeners() {
        ...
        monthSelectionListener.addObserver(entryDisplay);
        ...
        buttonPanel.getAddRevenueButton().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                AddButtonDialog revButtonDialog = new AddRevenueDialog(frame, budgetManager);
            }
        });
        ...
        buttonPanel.getAddExpenseButton().addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                AddButtonDialog expButtonDialog = new AddExpenseDialog(frame, budgetManager);
            }
        });

        // TODO implement theses if you want to deselect the other model when one is selected, and move into another moethod or sth look sos messy
        entryDisplay.getExpenseTableModel().addTableModelListener(new TableModelListener() {
            @Override
        ...
        entryDisplay.getRevenueTableModel().addTableModelListener(new TableModelListener() {
            @Override
            public void tableChanged(TableModelEvent e) {
